...
public class VezbanjeResource {
    ...
    */ 
    ...
    public String programVezbanja(String content) {
        ...
        List<Object[]> vezbe = DB.query("SELECT v.vezNaziv, epv.epvUcestalost, epv.epvbrSerija, epv.epvbrPonavljanja, epv.epvTrajanje, epv.epvNapomena "
    ...
    */
    ...
    public String programIshrane(String content) {
        ...
        List<Object[]> ishrana = DB.query("SELECT i.ishkolProteina, i.ishkolUgljenihHidrata, i.ishkolMasti, i.ishPrimer "
